<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\wamp3\wamp64\www\recruit\public/../application/admin\view\banner\bannerlist.html";i:1517812480;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<!-- 		<button class="layui-btn layui-btn-danger">
	...
	var tranStatus={
		...
		var articleTable = table.render({
			        ...
			        url: "<?php echo url('bannerlist'); ?>",
			        cols:[[
			         {checkbox: true},
			         {field: 'bannerid', title: '编号',type:"numbers" },
					  ...
					  if(layEvent === 'detail'){ //查看
					    ...
					    layer.confirm('确定删除该新闻么', function(index){
							  ...
							  layer.open({
							      ...
							      shade: false,
							      area: ['100%', '100%'],
							      content: "edit?bannerid="+data.bannerid
							    });
