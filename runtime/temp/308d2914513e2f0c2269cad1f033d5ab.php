<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\wamp3\wamp64\www\recruit\public/../application/admin\view\user\evaluser.html";i:1518603636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
		...
		var articleTable = table.render({
			        ...
			        <?php if(\think\Request::instance()->get('userid') != ''): ?>
			           where:{
			            ...
			            <?php endif; ?>
			        url: "<?php echo url('user/evaluser'); ?>",
			        cols:[[
			         {checkbox: true},
