<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\wamp3\wamp64\www\recruit\public/../application/admin\view\carousel\edit.html";i:1517304991;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<div class="imgupload" style="margin:15px 0 0 110px;width:640px;height:300px;text-align:center;border:1px solid #ccc; line-height:300px;position:relative;">
		...
		<img  src="<?php echo $vo; ?>" width='640px' height='300px' class="cover" style="position:absolute;top:0;left:0;z-index:-1;">
		<?php endif; ?>
