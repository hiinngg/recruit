<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\wamp6\wamp64\www\recruit\public/../application/admin\view\course\editCourse.html";i:1515897373;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<div class="layui-form-item">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="teacher" required  lay-verify="required" placeholder="请输入导师名" autocomplete="off" class="layui-input" value="<?php echo isset($data['teacher'])?$data['teacher']: ''; ?>">
    </div>
  </div>
