<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\wamp3\wamp64\www\recruit\public/../application/admin\view\course\courselist.html";i:1513848068;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<script type="text/html" id="bar">
  ...
  <button class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">删除</button>
   <button class="layui-btn layui-btn-danger layui-btn-xs" lay-event="show">首页显示</button>
  <!-- 这里同样支持 laytpl 语法，如： -->
