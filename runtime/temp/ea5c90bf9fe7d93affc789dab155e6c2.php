<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\wamp3\wamp64\www\recruit\public/../application/admin\view\banner\edit.html";i:1518314103;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<title>轮播图编辑（建议1920px * 400px）</title>
...
<div class="imgupload" style="margin:15px 0 0 110px;width:1920px;  overflow:hidden;  height:400px;text-align:center;border:1px solid #ccc; line-height:300px;position:relative;">
  ...
  <div class="layui-form-item">
	...
	layui.use(['form','upload','layer'], function(){
		  ...
		  form.on('submit(formDemo)', function(data){
	            ...
	            layer.msg("请上传广告图",{icon:5,shift:6})
	            return false;
	        }
                  ...
                  <?php if(isset($data)): ?>
                  data['bannerid']="<?php echo $data['bannerid']; ?>"
                  <?php endif; ?>
                      $.ajax({
                          url:url,
                          data:data,
