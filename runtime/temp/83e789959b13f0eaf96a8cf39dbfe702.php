<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\wamp6\wamp64\www\recruit\public/../application/admin\view\team\teamlist.html";i:1514017117;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <?php endif; ?>
            ...
            table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'detail'){ //查看
                    ...
                    layer.confirm('确定删除该团队定制么', function(index){
                        _ajax("<?php echo url('teamDel'); ?>",{pageid:data.pageid,path:data.content},dtd)
                        dtd.done(function(){
                            obj.del();
                            layer.close(index);
                        })
