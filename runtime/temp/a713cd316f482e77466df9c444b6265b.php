<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\wamp3\wamp64\www\recruit\public/../application/admin\view\user\courseuser.html";i:1517215599;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
	...
	var sex=['男','女'];
		...
		var articleTable = table.render({
		           ...
		           where:{
			        ...
			        url: "<?php echo url('user/courseuser'); ?>",
			        cols:[[
			         {checkbox: true},
...
<script type="text/html" id="bar">
  <button class="layui-btn layui-btn-xs" lay-event="detail">学员详情</button>
