<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\wamp6\wamp64\www\recruit\public/../application/index\view\user\mycourselist.html";i:1514378382;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<!-- 		<button class="layui-btn layui-btn-danger">
	...
	var tranStatus={
		...
		var articleTable = table.render({
			        ...
			        url: "<?php echo url('user/myCourseList'); ?>",
			        cols:[[
			         {checkbox: true},
...
<p>
<span>导师：{{d.teacher}}</span>&nbsp;&nbsp;
<span>联系方式：{{d.contact}}</span>
</p>
