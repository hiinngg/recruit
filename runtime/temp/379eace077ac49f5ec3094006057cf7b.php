<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\wamp3\wamp64\www\recruit\public/../application/companyadmin\view\talent\editTalent.html";i:1516432292;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<form class="layui-form" action=""  style="width:70%;">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="location" required  lay-verify="required" placeholder="请输入工作地点" autocomplete="off" class="layui-input" value="<?php echo isset($data['name'])?$data['name']:''; ?>">
    </div>
  </div>
