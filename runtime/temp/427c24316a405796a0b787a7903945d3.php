<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\wamp6\wamp64\www\recruit\public/../application/admin\view\page\editpage.html";i:1513783911;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<form class="layui-form" action=""  style="width:70%;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input" value="<?php echo isset($data['title'])?$data['title']: ''; ?>">
        </div>
    </div>
