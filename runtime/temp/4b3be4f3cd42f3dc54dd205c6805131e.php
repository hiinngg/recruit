<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\wamp6\wamp64\www\recruit\public/../application/admin\view\index\index.html";i:1517144937;}*/ ?>
<!DOCTYPE html>
<html>
			...
			<ul class="layui-nav layui-nav-tree" lay-filter="navtab">
				...
				<li class="layui-nav-item"><a href="#">职位管理</a>
					<dl class="layui-nav-child">
						...
						<dd>
							<a href="#"  data-url="<?php echo url('job/ctalent'); ?>">企业人才定制审核</a>
						</dd>
						<dd>
							<a href="#"  data-url="<?php echo url('job/cteam'); ?>">企业团队定制审核</a>
						</dd>
					</dl>
				</li>
				<li class="layui-nav-item"><a href="#"
