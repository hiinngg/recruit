<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\wamp6\wamp64\www\recruit\public/../application/admin\view\index\index.html";i:1514599129;}*/ ?>
<!DOCTYPE html>
<html>
			...
			<div class="layui-side-scroll">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="navtab">
					...
					<li class="layui-nav-item"><a href="#"
						...
						<li class="layui-nav-item"><a href="#"
						data-url="<?php echo url('course/courseUser'); ?>">课程报名列表</a></li>
						<li class="layui-nav-item"><a href="#"
						data-url="<?php echo url('job/jobUser'); ?>">工作申请列表</a></li>
				</ul>
			</div>
		</div>
