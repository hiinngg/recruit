<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\wamp6\wamp64\www\recruit\public/../application/admin\view\user\evalbyuse.html";i:1517143048;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<!-- 		<button class="layui-btn layui-btn-danger">
	...
	var tranStatus={
		...
		var articleTable = table.render({
			        ...
			        url: "<?php echo url('user/evalbyuse'); ?>",
			        where:{
