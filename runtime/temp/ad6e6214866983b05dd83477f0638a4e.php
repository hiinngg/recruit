<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\wamp3\wamp64\www\recruit\public/../application/index\view\index\index.html";i:1518333272;s:72:"D:\wamp3\wamp64\www\recruit\public/../application/index\view\layout.html";i:1518593388;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<div class="row-center  item <?php if($i == '1'): ?>active<?php endif; ?>"  style="text-align:center;width:100%;height:400px;line-height:400px; font-size: 0;" >
 <img   src="<?php echo $vo['src']; ?>"  <?php if($vo['url'] != ''): ?>data-url="<?php echo $vo['url']; ?>"<?php endif; ?>  class="mycarousel"  style=""  >
</div>
 <?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="row sever  " id="courselist" style="">
        ...
        <div class="modal-body">
        	...
        	<div class="form-group">
	        	<div class="col-md-12">
	        	  ...
	        	  <input type="password"  name="signpwd" id="signpwd" class="form-control" placeholder="请输入密码" />
	        	</div>
        	</div>
        	...
        	<div class="form-group">
	        	<div class="col-md-12">
	        	  ...
	        	  <input type="password"  name="signpwd2" id="signpwd2" class="form-control" placeholder="请确认密码" />
	        	</div>
        	</div>
...
$(".login").on("click",function(e){
 ...
 $(".userRegister").on("click",function(e){
    ...
    $signpwd=$("input[name='signpwd']");
    $signpwd2=$("input[name='signpwd2']");
    if($tel.val()==""){
    ...
    if($captcha.val()==""){
 	...
 	$.ajax({
		...
		data:{mobile:$tel.val(),code:$code.val(),captcha:$captcha.val(),signpwd:$signpwd.val(),signpwd2:$signpwd2.val()},
		beforeSend:function(){		
			layer.load(2);
		},
		type:"POST",
