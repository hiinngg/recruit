<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\wamp6\wamp64\www\recruit\public/../application/admin\view\job\joblist.html";i:1514706852;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
				...
				table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
					  ...
					  if(layEvent === 'detail'){ //查看
					    ...
					    layer.confirm('确定删除该工作定制么', function(index){
						  ...
						  _ajax("<?php echo url('statusChange'); ?>",{jobid:data.pageid,status:0},dtd)
						 dtd.done(function(){
