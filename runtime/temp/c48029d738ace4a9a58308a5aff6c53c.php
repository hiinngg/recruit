<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\wamp3\wamp64\www\recruit\public/../application/admin\view\job\cteam.html";i:1517186675;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>团队定制需求列表</title>
        ...
        <?php endif; ?>
            ...
            table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'detail'){ //查看
                    layer.alert(
                        '<p><strong>团队名称：</strong><span>'+data.name+'</span></p>'+
                        '<p><strong>定制说明：</strong></p>'+
                        '<p>'+data.desc+'</p>'+
                    ...
                    layer.prompt({
                        ...
                        $.ajax({
                            url:"<?php echo url('team/editfeedback'); ?>",
                            data:{teamid:data.teamid,text:value},
                            type:"post",
                            beforeSend:function(){
                                layer.load(2)
                            },
